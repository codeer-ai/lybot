...
const ChatInterface: React.FC = () => {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      text: "**LyBot**\n，您的立法院研究助理。我可以幫您查詢第 11 屆立委發言內容、提案、連署、投票記錄等。有什麼問題想了解嗎？\n\n**例如：**\n- 查詢特定立委的發言紀錄、會議資訊（目前品質： 可以！）\n- 查詢特定立委的提案、連署記錄（目前品質： 普通）\n- 了解法案、預算案的過程和投票結果（目前品質： 普通，或有挑戰）\n- 分析政黨表現、立委出席率（目前品質： 有挑戰）\n\n> 使用前，務必先閱讀 [免責聲明](#disclaimer)\n> 開始使用表示了解並同意該聲明\n\n**重要提醒：** 由於 AI 之特性及開發時間限制，\u200B出錯是可能的，請務必點擊回應中的相關連結自行查證。\n\n**目前僅支援第 11 屆立委**\n\n若有任何疑問，歡迎來信與我們聯繫： ly@codeer.ai\n\n(對 AI 回應有疑問，請附上「您的提問截圖」和「AI 的回應截圖」）",
      sender: "assistant",
      timestamp: new Date(),
    },
  ]);
